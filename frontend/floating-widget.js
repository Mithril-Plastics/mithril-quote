...
(function () {
  ...
  var CDN_WIDGET = 'https://cdn.jsdelivr.net/gh/Mithril-Plastics/mithril-quote@7375774/frontend';
  ...
  // ── MQ global config (only set if the page hasn't already set it) ───────────
  if (!window.MQ) {
    window.MQ = {
  ...
  var mqHtml = ''
    ...
    +       '</a>'
    +     '</div>'
    +     '<div class="mq-brand-right">'
    +       '<button class="mq-theme-btn" id="mq-theme-btn" title="Switch theme" aria-label="Toggle light/dark mode">'
    +         '<span class="mq-theme-sun">☀️</span>'
    +         '<span class="mq-theme-moon">🌙</span>'
    +       '</button>'
    ...
    +         '<p class="mq-turnaround" style="text-align:center;margin-bottom:12px">⚡ Often ready within a week</p>'
